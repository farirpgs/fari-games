...
Kate is playing as Amp, and wants to quickly leap across a catwalk unnoticed, timing it when the guards have their backs turned. It’s decided the action is using Flow. She has a 3 for Flow, and so rolls 3d6, keeping the highest result. Kate gets a 4: a success with a consequence. The GM describes Kate’s Frame landing on the catwalk, and then noticing the guards are changing shifts. The heavy boots of approaching soldiers echo off the walls!
...
By using the 3 Attributes, the players will think about not what they are capable of, but instead _how_ they want to approach the problem. Trust me, it keeps things moving and you all get the hang of it real quick.
...
Why? Two reasons. **<ins>First, Powers do not require rolls</ins>**. Second, the Powers are the opportunity for the players to show off, and sometimes being able to string together a weapon attack alongside a Power feels very very cool.
...
1. Change the Battle in a big way
2. Generate Drops
...
The important thing is that the change is big, so that the PCs <ins>have</ins> to change their tactics. They want to feel powerful, but it gets boring if they can wipe the floor with no real opposition. Write your GM’s Turn to reflect the sorts of things the GM should do to turn the PC’s approach on its head.
...
Loyal foot soldiers. They obey commands, but look for opportunities to ascend.
...
1. Name of the weapon type (e.g. rifle, sword, lascannon)
2. Harm the weapon deals by default
3. Range that the weapon works at (e.g. Close/Near, or Far only)
4. (Optional) Any Tags the weapon requires
...
2. Create classes. Each class needs:
   ...
   3. Resource
   4. 3-5 Powers
3. Create enemies. Each enemy needs: 5. Health 6. Harm 7. 3 Moves
4. Create weapon types and tags. Each weapon type needs: 8. Harm 9. Range 10. Optional required tags
