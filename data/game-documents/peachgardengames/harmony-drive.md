...
- One die if they have a relevant Skill
...
In order to cast a spell, a player takes one Terrain Spell Piece from the GM and one Personal Spell Piece from their own list. They describe what they want this two-word phrase to do, and then they work with the GM to decide how much of their Magic (called “Scatter” in Heroic Chord) the spell will cost.
...
The GM should cost spells based on how far they go to solve problems. Heroic Chord includes this list (which is based on a max 10 Scatter)
...
_**Daring** – The tendency to do, to choose an action and commit._

_**Understanding** – The tendency to study, to use information to solve problems._

_**Sensitivity** – The tendency to take in information about your surroundings, to use your senses._

_**Subtlety** – The tendency to hide your actions or your motives._

_**Adaptability** – The tendency to wait and see, to change course based on the situation._
...
In Heroic Chord, a character starts with 1 in each Facet, and then adds 5 more split among the Facets as they choose.

You might want to change this by giving the players more or fewer points to divide up. You might also want to set maximums to prevent players from placing all their points in a single Facet.
...
Heroic Chord has 19 different skills in it. You may want to have more or fewer in your own game.

The skills in Heroic Chord are:
...
When writing up your Skills section, try and give examples of ways different approaches could change how the skill is used, and suggestions for Edge Success bargains. For example, a skill entry from Heroic Chord looks like this:
...
A character in Heroic Chord starts with nine skills. They get five from their Class (more on that coming up) and four more of their own choosing. That means that a starting character has roughly half the game’s skills.
...
Combat specialties are optional abilities that change the way a character interacts with the encounter system. They’re not necessary, but they help add variety between characters of the same class on a tactical level. A character chooses one at creation.

If you decide to include Combat Specialties in the game, I would suggest making at least ten. Enough that players can make characters repeatedly without doubling up.

A Combat Specialty from Heroic Chord looks like one of these:

_**Emissary** – Against a Noble Demon or its Lesser Daemons, the difficulty for you to Redirect is reduced by 2._

_**Purifier** – Against a Horror, the difficulty for you to Destroy is reduced by 2_

_**Survivor** – Against a natural disaster, the difficulty for you to Outlast is reduced by 2._

When writing Combat Specialties, be careful to try and keep them at about the same power level. If one of the Specialties is numerically just better than the others, then it becomes the “correct” choice, and then your hard work on the other Specialties will be ignored!
...
Whether or not your game includes classes, you will need some way for the players to build their Personal Spell Piece list. In Heroic Chord, each class comes with 12 Spell Pieces, of which the players get to choose six.
...
When a character invokes their Key, they mark off that word from their list. Then, they roll an additional two dice on their next action.

When all five words from their Key are marked off, the character gets their Magic resource (Scatter, in Heroic Chord) refreshed, and they can cast their Signature Spell until the arc ends.
...
In Harmony Drive, a character has 10 HP and 0 Magic

When they reach 0 HP or 10 Magic, they lose consciousness.
...
In the base game, Scatter is recovered by a good night’s rest. You might choose to have magic come back in a different way, but be careful not to make it so precious that players never cast spells!
...
Every class has three abilities per “level”, and as characters advance they choose a new ability from their class list. This lets two characters in the same class play differently and have different strengths and weaknesses.
...
Here are some sample abilities from Heroic Chord:

_**Anchor Note:** When you cast a spell or Chord, if you do so while playing music, you gain one fewer Scatter. (Tidal Navigator, Season 1)_

_**Supporter:** You can gain two Scatter in order to gain an additional action in a round, provided you use both your actions to increase the Advantage Pool. (Enduring Crusader, Season 2)_

_**Gallantry:** If there is a helpless person nearby, you gain an extra action in combat to protect them. This can be an NPC or incapacitated ally. (Windswept Cavalier, Season 4)_
...
Assist Pools represent a special source of power, outside the player, that they have access to. In Heroic Chord, these are things that the gods allow people to connect to, like an animal companion, the weather, or the spirits of the dead.

Characters in your game might have a sentient weapon they can connect to, or a demonic familiar, or a friend in a high place. The important thing about Assist Pools is that they represent a special power players can turn to for help. In Heroic Chord, they’re tied to classes as a central feature.
...
Here’s the Assist Pool for the Heroic Chord class Windswept Cavalier:
...
In Heroic Chord, every Assist Pool has 5 Scatter to start. You might want your Assist Pools to have their own resource, or you might use your game’s Magic or Health resources. What matters here is that there’s a finite amount of power here.
...
These are powers that the players can use in exchange for spending their Assist Pool resource. Like the Spell Pieces, these should be different from things the players can do on their own – they represent an exceptional source of help.
...
Here are some more examples from Heroic Chord:
...
Let’s start by taking a look at an Encounter from Heroic Chord:

_**Shipwreck** (2 turns per round)_
...
2. **Redirect.** To convince the Encounter to take a different route.
...
Once the Season ends, every character gets to choose a new ability from their class list. Consider “Season” this game’s equivalent of “Level”.
